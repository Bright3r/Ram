...
inline void upsilon61_1() noexcept
{
	...
	writeGraphsToFile("graphs/61/upsilon1.adj", graphs);
}


inline void upsilon61_2() noexcept
{
	auto upsilon1 = loadBulk("graphs/61/upsilon1.adj");
	std::vector<EdgeColoredUndirectedGraph> ts = { make_T1(), make_T2() };
	...
	// Save graphs
	writeGraphsToFile("graphs/61/upsilon2.adj", graphs);
}


inline void upsilon61_3() noexcept
{
	auto upsilon2 = loadBulk("graphs/61/upsilon2.adj");
	std::vector<EdgeColoredUndirectedGraph> ts = { make_T1(), make_T2() };
	...
	// Save Graphs
	writeGraphsToFile("graphs/61/upsilon3.adj", graphs);
}
...
inline void upsilon61_4() noexcept
{
	...
	auto upsilon3 = loadBulk("graphs/61/upsilon3.adj");
	...
	// Save to file
	writeGraphsToFile("graphs/61/upsilon4.adj", graphs);
}
...
{
	auto t_perms = make_tperms();
	auto upsilon4 = loadBulk("graphs/61/upsilon4.adj");
	...
	// Save to File
	writeGraphsToFile("graphs/61/upsilon5.adj", graphs);
}
